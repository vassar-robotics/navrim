...
const OpenaiToken: React.FC = () => {
  ...
  const handleDeleteToken = async () => {
    if (window.confirm('Are you sure you want to delete the OpenAI API key?')) {
  ...
  return (
    <div className="space-y-4">
      <div>
        <h3 className="text-base font-semibold text-gray-800 mb-1">OpenAI API Key</h3>
        <div className="flex items-start gap-2 text-sm text-gray-600">
          ...
          <p>
            ...
            and create an API key with appropriate permissions for your use case.
          </p>
        </div>
      </div>
