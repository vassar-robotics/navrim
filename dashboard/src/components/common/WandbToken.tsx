...
const WandbToken: React.FC = () => {
  ...
  const handleDeleteToken = async () => {
    if (window.confirm('Are you sure you want to delete the Weights & Biases API key?')) {
  ...
  return (
    <div className="space-y-4">
      <div>
        <h3 className="text-base font-semibold text-gray-800 mb-1">Weights & Biases API Key</h3>
        <div className="flex items-start gap-2 text-sm text-gray-600">
          ...
          <p>
            ...
            and copy your API key for tracking experiments and metrics.
          </p>
        </div>
      </div>
